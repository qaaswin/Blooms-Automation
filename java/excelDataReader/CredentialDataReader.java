...
public class CredentialDataReader {
	...
	public ArrayList<String> getData(String testcaseName) throws IOException {
		...
		FileInputStream fis = new FileInputStream("/home/cubet/Desktop/Selenium/BloomsAutomationProject/Blooms/Data Input Files/LoginCredentials.xlsx");
		...
		//3. Get access all rows of sheet
		...
		//5. Access data from each cell in to arrays
